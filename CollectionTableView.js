...
define(['backbone', 'underscore', 'config', 'stickit'], function (Backbone, _, config) {
	var CollectionTableView = Backbone.View.extend({
		...
		initialize: function (options) {
            ...
            if(typeof(options.row_id_field)==="undefined"){
				console.error("The option row_id_field must be passed to the CollectionTableView");
			}
            if(typeof(options.columnInfo)==="undefined"){
                console.error("The option columnInfo mulst be passed to the CollectionTableView");   
            }
			...
			if(typeof(this.paginatorProp.showPaginator)==="undefined"){
		...
		initializeTable: function () {
			...
			this.original_collection.each(function(_model){
				self.addRow(_model);
                //console.log(_model.get(self.row_id_field));
			});
		...
		addRow: function(_model,opts){
            ...
            model.set(this.row_id_field,_model.get(this.row_id_field)); 
